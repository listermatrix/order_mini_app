                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" name="first_name" value="{{$user->first_name}}" placeholder="First Name" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" name="middle_name" value="{{$user->middle_name}}" placeholder="Middle Name" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" name="last_name" value="{{$user->last_name}}" placeholder="Last Name" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="input-group">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" name="username" value="{{$user->username}}" placeholder="auto generated" type="text" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="input-group">
                                            ...
                                            <div class="col-md-9">
                                                @php  $old_role = $user->role_id   @endphp
                                                <select class="form-control" id="role" name="role" data-toggle="select">
                                                    <option></option>
                                                    @foreach($roles as $role)
                                                        <option value="{{$role->id}}" {{$old_role == $role->id ? 'selected' : '' }}>{{strtoupper($role->name)}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
