                        ...
                        <table id="dataTable" class="table align-items-center table-flush">
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{route('order.edit',$order->id)}}"><i class="fas fa-pencil-alt"></i></a>
                                        <a class="btn btn-danger btn-sm {{ $dep_id !== 3 ? 'invisible' : ''}}" href="{{route('order.log',$order->id)}}"><i class="fas fa-file-alt"></i></a>
                                    </td>
                                </tr>
